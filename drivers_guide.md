# SwachhLens — Municipal Corporation of Hyderabad
## Driver Portal & Route Collection Guide

Welcome to the SwachhLens Driver Portal. This guide details the login credentials for all municipal waste collection trucks in Hyderabad and explains how to operate the driver dashboard to execute optimized routes.
...
1. Open the SwachhLens Driver Portal URL: `http://localhost:5173/driver`.
