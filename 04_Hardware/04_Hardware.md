...
Since deploying physical sensors across a city for initial testing is cost-prohibitive, the SwachhLens project heavily relies on the **Wokwi** simulator. Wokwi allows us to compile and run standard Arduino C++ code on a simulated ESP32 microcontroller directly in the browser or via VS Code.
