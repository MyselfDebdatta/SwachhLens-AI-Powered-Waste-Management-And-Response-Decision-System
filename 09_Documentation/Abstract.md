...
Municipal solid waste management is hindered by static, inefficient collection routing, leading to excessive carbon emissions and overflowing bins. **SwachhLens** introduces an end-to-end Smart Waste Management system. By employing ESP32 microcontrollers simulated via Wokwi, real-time telemetry is collected. SwachhLens utilizes XGBoost to forecast fill levels 24 hours into the future, and a Google OR-Tools CVRP solver to generate a dynamically optimized path.

## 2. Core Abstract Metrics

```mermaid
pie title Project Outcomes
    "Routing Distance Saved" : 33
    "Overflows Prevented" : 80
    "Traditional Waste" : 20
```

## 3. Results Comparison

| Metric | Traditional System | SwachhLens AI System | Resulting Impact |
| :--- | :--- | :--- | :--- |
