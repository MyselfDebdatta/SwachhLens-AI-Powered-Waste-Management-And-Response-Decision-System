...
**Project Name:** SwachhLens: Smart Waste Fill-Level Prediction & Route Optimization  
**Description:** SwachhLens is an AI-powered municipal waste management system that simulates IoT bin sensors, predicts waste levels, identifies overflow risks, and solves vehicle routing using Google OR-Tools.
